            ...
            <div className="absolute inset-0 flex items-center justify-start">
              <div className="max-w-7xl mx-auto px-6 sm:px-12 w-full">
                ...
                >
                  ...
                  <button
                    className="bg-orange-500 hover:bg-orange-600 px-8 sm:px-10 py-3 sm:py-4 rounded-lg text-sm sm:text-base font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
                  >
                    {slide.button}
                  </button>
                </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <p className="text-orange-500 max-w-4xl mx-auto text-sm sm:text-base">
                  Quality Work | Professional worker | Small and Big repairs | Charges after work | Fixed on same day
                  <br />
                  New steel products manufacturing | Old steel products Repairing
                </p>
              </div>
